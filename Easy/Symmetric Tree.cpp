...
class Solution{
    ...
    bool specchio (struct Node* r1, struct Node* r2)
    {
        if (r1 == NULL && r2 == NULL) return true;
        
        if (r1 && r2 && r1->data == r2->data) return specchio(r1->left, r2->right) &&
                                                     specchio(r1->right, r2->left);
    ...
    bool isSymmetric(struct Node* root)
    {
        ...
        If both node1 and node2 are not NULL: Return 
            ((node->data == node2->data) && (isSymm (node1->left, node2->right) && (isSymm (node1->right, node2->left))
        */
        
        return specchio(root, root);
